...
namespace Authentication
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerfactory)
        {
            ...
            // add users
            CreateUsers(app.ApplicationServices).Wait();
        }


        private static async Task CreateUsers(IServiceProvider applicationServices)
        {
            var userManager = applicationServices.GetService<UserManager<ApplicationUser>>();

            // add user with CanEdit permissions
